...
exports.XMLHttpRequest = function() {
  ...
  Object.defineProperty(this, "timeout", {
    ...
    set: function(value) {
      ...
      if (value > 0) {
        ...
        if (typeof requestStart !== "undefined") {
          var end = (timeout + requestStart) - Date.now();
          timeoutId = setTimeout(timedOut.bind(this), end);
        }
      }
    }
  });
  ...
  var timedOut = function() {
    ...
    // TODO: This is most likely wrong, since it doesn't emit progress and
    // loadend events as per the spec.
  ...
  this.send = function(data) {
    ...
    if (settings.async) {
      ...
      if (timeout > 0) {
        timeoutId = setTimeout(timedOut.bind(this), timeout);
      }
